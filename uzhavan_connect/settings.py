"""
Django settings for uzhavan_connect project.
...
SECRET_KEY = 'django-insecure-v_-w!08o#zubrlsdxmj0*ns35s*k5daum_jakrk0q#r!5u_53p'
...
ROOT_URLCONF = 'uzhavan_connect.urls'
...
WSGI_APPLICATION = 'uzhavan_connect.wsgi.application'
